...
automl_run_id = 'shy_helmet_qhbchfmmy3_2'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/eastus/workspaces/590842d7-7019-4b6b-a689-12dd4e1cbd2d/data/alugueldebicicletas/versions/1',     help='Default training dataset uri is populated from the parent run')
